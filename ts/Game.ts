class Game extends EntitiesManager{
    ...
    drawBoard(){
        ...
        this.Board.forEach(row => {
            row.forEach(entity => {
                if(entity !== undefined) this.drawEntity(entity.Settings.x, entity.Settings.y, entity.Identifier.color);
            });
        });
    }

    drawEntity(x:number, y:number, color:string){
